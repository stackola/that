      ...
      >
            ...
            <VoteButtons
              ...
              onUpvote={() => {
                if (this.props.user && this.props.user.id) {
                  vote({
                    path: "/groups/" + data.group + "/posts/" + data.id,
                    id: data.id,
                    vote: "up"
                  });
                } else {
        ...
        {this.props.condensed ? (
          ...
          >
            ...
            {this.props.data.image && this.props.data.image.url && (
              <View
                maxScale={3}
                panStart={() => {
                  this.props.updatePan && this.props.updatePan(true);
                }}
                panEnd={() => {
                  this.props.updatePan && this.props.updatePan(false);
                }}
                style={{
                  overflow: "hidden",
                  alignItems: "center",
          ...
          <View style={{ flex: 5, padding: 8, paddingBottom: 0 }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.text }}>{this.props.data.text}</Text>
            </View>
