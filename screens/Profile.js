            ...
            <View style={{ flexDirection: "row", height: 40 }}>
              ...
              >
                <Text
                  style={{
                    color: colors.text,
                    fontWeight: this.state.tab == "posts" ? "500" : "400",
                    textDecorationLine:
                      this.state.tab == "posts" ? "underline" : null
                  }}
                >
                  Posts
                </Text>
              ...
              >
                <Text
                  style={{
                    color: colors.text,
                    fontWeight: this.state.tab == "comments" ? "500" : "400",
                    textDecorationLine:
                      this.state.tab == "comments" ? "underline" : null
                  }}
                >
                  Comments
                </Text>
